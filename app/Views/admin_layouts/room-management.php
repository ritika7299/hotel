    ...
    <div class="header">
        ...
        <script>
            function performSearch() {
                ...
                const subject = document.getElementById('fromInput').value.toLowerCase();

                // Example data array
                const data = [
                    { from: 'Alice', to: 'Bob', subject: 'Meeting' },
                    { from: 'Charlie', to: 'Dave', subject: 'Project' },
                    { from: 'Eve', to: 'Frank', subject: 'Report' }
                ];
                ...
                console.log(results); // Display results in console or update the UI accordingly
            }
        </script>
        <!-- header-right -->
...
<!-- add room modal script by ritika -->
<!-- <script>
                        ...
                        $('#submitRoomDetails').on('click', function () {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    $('#addroom-modal').modal('hide'); // Hide modal
                                    // Optionally, refresh the room list or update the UI
                                },
...
<!-- <script>
    $(document).on("submit", "#addDetailsForm", function (event) {
...
<script> $(document).ready(function () {
        $('#addDetailsmodal').click(function () {
            var id = $(this).attr("id");
            //alert(id);
            $.ajax({
                url: "<?php echo base_url('admin/') ?>", method: "POST", data: { id: id }, datatype: 'JSON'
                success: function (data) {
                    alert(data); //console.log(data); $('#your_modal_detail').html(data);
