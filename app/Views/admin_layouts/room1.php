...
<body>
            ...
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <!-- <ul class="submenu">
                            <li>
                                <a href="add-reservation.html">Add</a>
                            </li>
                            <li>
                                <a href="update-reservation.html">Update</a>
                            </li>
                            <li>
                                <a href="delete-reservation.html">Delete</a>
                            </li>
                        </ul> -->
                    </li>
                    <!-- /Reservation -->
                    ...
                    <li class="dropdown">
                        ...
                        <!-- <ul class="submenu">
                            <li>
                                <a href="add-rooms.html">Add Room</a>
                            </li>
                            <li>
                                <a href="update-rooms.html">Update Room</a>
                            </li>
                            <li>
                                <a href="delete-rooms.html">Delete Room</a>
                            </li>
                        </ul> -->
                    </li>
                    <!-- /Room management -->
                    ...
                    <li class="dropdown">
                        ...
                        <!-- <ul class="submenu">
                            <li>
                                <a href="new-guest-request.html">New Guest request</a>
                            </li>
                            <li>
                                <a href="add-guest.html">Add Guest</a>
                            </li>
                            <li>
                                <a href="udate-guest.html">Update Guest</a>
                            </li>
                            <li>
                                <a href="delete-guest.html">Delete Guest</a>
                            </li>
                            <li>
                                <a href="guest-feedback.html">Guest feedback</a>
                            </li>
                        </ul> -->
                    </li>
                    <!-- /Guest management -->
                    ...
                    <li class="dropdown">
                        ...
                        <!-- <ul class="submenu">
                            ...
                            <li>
                                <a href="update-staff.html">Update Staff</a>
                            </li>
                            <li>
                                <a href="delete-staff.html">Delete Staff</a>
                            </li>
                            <li>
                                <a href="staff-leave.html">Manage Staff leave </a>
                            </li>
                        </ul> -->
                    </li>
                    <!-- /staff management -->
                    ...
                    <!-- calendar -->
                    <li>
                        <a href="<?php echo base_url('calender/'); ?>" class="dropdown-toggle no-arrow">
    ...
    <div class="main-container">
        ...
        <div class="inner-content">
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    <div class="page-header">
                        <div class="row">
                            <!--test  -->
                            <!-- <div class="reports">Room</div> -->
                            <!--/test  -->
                            <div class="col-md-12">
                                <div class="btn btn-success pull-right" data-toggle="modal"
                                    data-target="#addroom-modal">
                                    Add <i class="micon fa fa-plus"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            <a href="#" data-color="#FABC3F" style="color: rgb(156, 129, 9)"><i
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="tab-wizard wizard-circle wizard clearfix" role="application" action="#"
                                        method="POST" id="steps-uid-0">
                                        <div class="content clearfix">
                                            <div class="col-md-12">
                                                <div class=" form-group">
                                                    <select class="form-control">
                                                        <option data-select2-id="01" value="room_floor"
                                                            id="floorSelect">
                                                            Select Floor
                                                        </option>
                                            ...
                                            <div id="floorInfo">
                                                <div class="col-md-12">
                                                    <div class="form-group"><select class="form-control "
                                                            id="selectGround" name="room_no">
                                                            <option data-select2-id="05" value="">Select Room no.
                                                            </option>
                                                            <!-- for ground -->
                                                            <option data-select2-id="06" value="G101">101</option>
                                                            <option data-select2-id="07" value="G102">102</option>
                                                            <option data-select2-id="08" value="G103">103</option>
                                                            <option data-select2-id="09" value="G104">104</option>
                                                            <!--for first -->
                                                            <option data-select2-id="10" value="FA1">201</option>
                                                            <option data-select2-id="11" value="FA2">202</option>
                                                            <option data-select2-id="12" value="FA3">203</option>
                                                            <option data-select2-id="13" value="FA4">204</option>
                                                            <!-- for second -->
                                                            <option data-select2-id="14" value="FB1">301</option>
                                                            <option data-select2-id="15" value="FB2">302</option>
                                                            <option data-select2-id="16" value="FB3">303</option>
                                                            <option data-select2-id="17" value="FB4">304</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class=" form-group">
                                                    <select class="form-control" id="selectStatus">
                                                        ...
                                                        <option data-select2-id="23" value="book">Book</option>
                                                        <!-- <option data-select2-id="24" value="booked">Booked</option> -->
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-12" id="addPrice">
                                                <div class="form-group">
                                                    <input class="form-control" type="text" placeholder="Add Price">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="<?php echo base_url('room/add'); ?>" data-toggle="" data-target=""><button
            ...
            <!-- footer wrap -->
            <div class="footer-wrap pd-20 mb-20 mt-3 ml-1 mr-2 card-box">
