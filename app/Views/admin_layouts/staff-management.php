    ...
    <div class="main-container">
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="text" id="firstname"
                                                    placeholder="First Name" value="" name="firstname" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class=" form-group">
                                                <select class="form-control" id="gender" name="gender" value=""
                                                    required>
                                                    <option data-select2-id="10" selected>
                                                        Select
                                                        Gender
                                                    </option>
                                                    <option data-select2-id="11" value="male">Male
                                                    </option>
                                                    <option data-select2-id="12" value="female">Female
                                                    </option>
                                                    < </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="text" id="address"
                                                    placeholder="Address" value="" name="" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class=" form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class=" form-group">
                                                ...
                                                <select class="form-control" id="card_id" value="" name="card_id"
                                                    required>
                                                    <option data-select2-id="15" value="si" selected>Select ID</option>
                                                    <option data-select2-id="16" value="vi">Voter ID-Card</option>
                                                    <option data-select2-id="17" value="ac">Aadhaar Card</option>
                                                    <option data-select2-id="18" value="pc">Pan Card</option>
                                                    <option data-select2-id="19" value="pp">Passport</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class=" form-group">
                                                <input class="form-control" id="idno" name="idno" value="" type="text"
                                                    placeholder="Id numbers">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <!-- /add-staff modal -->
                <!-- Update-staff modal -->
                <div class="modal fade" id="update-staff-modal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="tab-wizard wizard-circle wizard clearfix" role="application" method="POST"
                                    id=" steps-uid-0" action="<?= base_url('staff/update_details'); ?>">
                                    <div class="content clearfix">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class=" form-group">
                                                    <select class="form-control" id="gender" required>
                                                        <option data-select2-id="10" value="">
                                                            Select
                                                            Gender
                                                        </option>
                                                        <option data-select2-id="11" value="ground">Male</option>
                                                        <option data-select2-id="12" value="first">Female</option>
                                                        < </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class=" form-group">
                                                    <select class="form-control" id="post" value="" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class=" form-group">
                                                    <select class="form-control" id="card_id" value="" required>
                                                        <option data-select2-id="15" value="">Select ID</option>
                                                        <option data-select2-id="16" value="vid">Voter ID-Card</option>
                                                        <option data-select2-id="17" value="aid">Aadhaar Card</option>
                                                        <option data-select2-id="18" value="pid">Pan Card</option>
                                                        <option data-select2-id="19" value="passid">Passport</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class=" form-group">
                                                    <input class="form-control" id="idno" value="" type="text"
                                                        placeholder="Id numbers">
                                                </div>
                                            </div>
                                        </div>
