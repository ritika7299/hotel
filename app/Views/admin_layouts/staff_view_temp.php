    ...
    <div class="main-container">
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="btn btn-primary pull-right" data-toggle="modal"
                                    data-target="#AddStaff-modal">
                ...
                <!-- Datatable End -->
                <!-- add-staff modal -->
                <div class="modal fade" id="AddStaff-modal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="AddStaffDetails">
                                    <div class="content clearfix">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input class="form-control" type="text" id="fullname"
                                                        placeholder="Enter Full Name" value="" name="fullname" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class=" form-group">
                                                    <input class="form-control" id="empid" name="empid" value=""
                                            ...
                                            <div class="col-md-6">
                                                <div class=" form-group">
                                                    <select class="form-control" id="post" name="post" value="post"
                                                        required>
                                                        <option data-select2-id="11" value="wp">Select
                                                            Work Profile
                                                        </option>
            ...
            <div class="footer-wrap pd-20 mb-20 mt-3 card-box">
                Theme
                <a href="https://github.com/dropways" target="_blank">© 2024</a>
            </div>
            <!-- footer wrap -->
