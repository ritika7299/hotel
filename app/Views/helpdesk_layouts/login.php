                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h2 class="text-center" style="color: #4A249D;">Login</h2>
                        </div>
                        <!-- login form  -->
                        ...
                        <form action="<?php echo site_url('login/loginAuth'); ?>" method="POST">
                            ...
                            <div class="input-group custom">
                                ...
                                <div class="input-group-append custom">
                                    <span class="input-group-text" id="togglePassword" class="toggle-icon"><i
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group mb-0">
                                        <button style="background-color: #4A249D;color: white; border: none;"
