                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                    <div class="search-data"><input type="search" class="form-control form-control-sm"
                                            placeholder="Search" aria-controls="DataTables_Table_0"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                <a href="#" data-color="#265ed7" data-toggle="modal"
                                                    data-target="#view-invoicedetails-modal">
                                                    <i class="icon-copy dw dw-eye btn btn-secondary"></i>
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="dataTables_info" id="DataTables_Table_0_info" role="status"
                                    aria-live="polite">9-10 of 10 entries</div>
                            </div>
                                    ...
                                    <ul class="pagination">
                                        <li class="paginate_button page-item previous" id="DataTables_Table_0_previous">
                                            <a href="#" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0"
                                                class="page-link"><i class="ion-chevron-left"></i></a>
                                        </li>
