                    ...
                    <div class="clearfix mb-20">
                        <div class="col-md-6 col-sm-12 text-right pull-right">
                            <div class="btn btn-info" data-toggle="modal" data-target="#reservation-modal">
                                Add button <i class="micon fa fa-plus"></i>
                            </div>
                        </div>
                    </div>
                    <!-- add table here -->
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg w-100">
                        <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12 col-sm-12 mb-30">
                                            <div class="pd-30 height-100-p">
                                                ...
                                                <div id="guest-information" class="guest-information"
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-info" form="addRoomDetailsForm"
...
<script src="<?php echo site_url(); ?>public/src/plugins/fullcalendar/fullcalendar.min.js"></script>
<!-- <script src="public/backend/src/plugins/apexcharts/apexcharts.min.js"></script> -->
...
<script src="<?php echo site_url(); ?>public/backend/src/scripts/dynamic-calander.js"></script>
